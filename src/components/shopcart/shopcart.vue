<template>
    ...
    <div class="list-mask" v-show="isShow" transition="fade" @click="toggleCart"></div>
</template>
...
<script type="text/ecmascript-6">
  ...
  export default {
    props:['foodList','deliveryPrice','minPrice','updateFoodCount','clear'],
    data () {
      return {
        isEnough:'not-enough',
        isShow: false
